                                     ...
                                     GError **error)
{
  ...
  if (garrow_error_check(error, status, "[arrow][file-writer][new-arrow]")) {
                                    ...
                                    GError **error)
{
  ...
  if (!garrow_error_check(error, status, "[arrow][file-writer][new-path]")) {
    return NULL;
  }
                                       ...
                                       GError **error)
{
  ...
  return garrow_error_check(error, status, "[arrow][file-writer][write-table]");
}
                                 ...
                                 GError **error)
{
  ...
  return garrow_error_check(error, status, "[arrow][file-writer][close]");
}
